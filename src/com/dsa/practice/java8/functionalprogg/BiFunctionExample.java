...
public class BiFunctionExample {
	...
	public static void main(String[] args) {
		// Bifuction 2 inputs List<Instructors> and second is predicate which will
		// filter if instructor has online
		// courses and return a map of <String,Integer> string is name and Integer is
